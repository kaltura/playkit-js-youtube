...
##### Prerequisites
- [ ] Have you checked for duplicate [issues](https://github.com/kaltura/playkit-js-youtube/issues): ______
- [ ] Which Plugin [version](https://github.com/kaltura/playkit-js-youtube/releases) are you using: ______
